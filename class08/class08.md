...
There are 569 observations of 30 variables - not including the id
variable for wisc.data. There are 569 observations for the diagnosis
vector.
...
PC1: proportion of variance = 0.4427. 44.27% of the original variance is
captured by PC1.

> Q5. How many principal components (PCs) are required to describe at
> least 70% of the original variance in the data?

PC3: cumulative proportion = 0.72636. It takes 3 principal components to
describe at least 70% of the original variance in the data.

> Q6. How many principal components (PCs) are required to describe at
> least 90% of the original variance in the data?

PC7: cumulative proportion = 0.91010. It takes 7 principal components to
...
It is absolutely unreadable. I can’t read or distinguish any data
points.
...
Both plots are centered at 0,0, however, PC1 vs PC3 has a tighter
grouping and less outliers. PC1 is capturing the separation of malignant
from benigned samples.
...
Ward.D2 gives the cleanest separation between the samples. Each row is
obvious which B or M is the majority, unlike the others.
...
It does a pretty decent job, where out of 216, 188 was identified as
malignant. And, out of 353, 329 was identified as benign.
...
It does comparably worse than the 2 cluster model. For cluster 3 it had
343 B and 40 M which is worse than the 2 cluster model. It also needed 4
cluster for clear separation. Doing PCA first shows substantive
improvement.
...
Patient 2 should be prioritized first because it is on the cluster that
was overwhelmingly malignant is the previous table() answer.
