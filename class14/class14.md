...
```
    ...
    Info: Working in directory /Users/daniel/Documents/Projects/bimm143/bimm143_git/class14
...
Cell Cycle, Mitotic. Cell Cycle. Cell Cycle Checkpoints have the most
significant p-values. Yes one of the files returned is the Cell Cycle
pathway. They lookup different databases and that could be the cause for
the difference.
